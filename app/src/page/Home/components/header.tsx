    ...
    <>
      {userLoggedIn ? (
        <div className="bg-primary text-primary-foreground">
          <div className="mx-auto flex h-full max-w-7xl items-center justify-end gap-6 px-4 sm:px-6 lg:px-8">
            <h3 className="scroll-m-20 py-3 text-center text-sm font-extrabold tracking-tight text-balance">
              Hi, {user?.username}
            </h3>
          </div>
        </div>
