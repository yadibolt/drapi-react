      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: count }).map((_, i) => (
            ...
            >
              <div className="h-56 w-full rounded-t-xl bg-slate-200/70 dark:bg-slate-700/40 object-cover animate-pulse" />

              <div className="p-4">
                <div className="h-6 w-3/4 rounded bg-slate-200/70 dark:bg-slate-700/40 animate-pulse mb-3" />
